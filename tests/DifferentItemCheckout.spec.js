...
test('Verify if user can use different items in checkout', async ({ page }) => {
  ...
  await page.getByRole('link', { name: 'Reptiles' }).click();
  await expect(page.locator('h3')).toContainText('Reptiles');
  await page.getByRole('link', { name: 'RP-SN-' }).click();
